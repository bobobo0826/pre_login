...
yundama_username = '18264502806'
yundama_password = 'cgghovf3'
...
def login(username, password):
    # su 是加密后的用户名
    su = get_su(username)#获得加密后用户名
    sever_data = get_server_data(su)# 预登陆获得 servertime, nonce, pubkey, rsakv
